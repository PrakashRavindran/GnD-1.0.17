...
<link href="<c:url value='/resources/css/style.css'/>"
	media="screen, projection" rel="stylesheet" type="text/css">
<link href="<c:url value='/resources/css/easyui.css'/>"
	media="screen, projection" rel="stylesheet" type="text/css">
<link href="<c:url value='/resources/css/icon.css'/>"
	media="screen, projection" rel="stylesheet" type="text/css">
...
#checkboxSelectCombo, #checkboxSelectCombo:hover, #checkboxSelectCombo1,
	#checkboxSelectCombo1:hover {
...
.ui-igcombo-clear {
				...
				<ul>
					...
					<c:if
						...
						<li id="icons" class="selected"><a
							href="<c:url value='/master/masterdb'/>">Master DB</a></li>
	...
	<div class="main" style="">
		<div class="container main-conten">
			<div class="left-content">
				<div class="demo-left-nav" id="left-nav">
					<div class="navigation">
						<ul>
							<li><a href="<c:url value='/master/branchSearch'/>">Branch</a>
							</li>
							<li><a href="<c:url value='/master/bank'/>">Bank</a></li>
							<li><a href="<c:url value='/upload/getProduct'/>">Products</a>
							</li>
							<details dislay="no"> <summary>AWB</summary>
							<ul>
								<li class="selected"><a
									href="/GnD/upload/getserviceprovider">AWB</a></li>
								<ul>
									<li><a href="/GnD/master/getServiceproviders">export
											AWB</a></li>
								</ul>
							</details>
					</div>
			...
			<div class="right-content record">
				...
				<form name="awbform" onsubmit="return validate()" method="post"
					...
					<div class="col-md-12">
						<div class="col-md-8">
							<div class="col-md-12">
								<table>
									<tr>
										<td><label class="label"> <input type="radio"
												id="fn" class="radiobutton" name="my-radiobutton-group">
												<span class="custom-radiobutton"></span>
										</label></td>
										<td class="cen"><span class="blue-text">File
												Upload</span>
									...
									<tr>
										<td><label class="label"> <input type="radio"
												class="radiobutton" name="my-radiobutton-group" id="range">
												<span class="custom-radiobutton"></span>
										</label></td>
										<td>
											<div class="col-md-12">
									...
									<tr>
										<td>
											...
											<button class="btn btn-l btn-blue" type="submit"
		...
		<div class="col-md-2 border-class">
			<label class="label"> <c:forEach var="listValue"
					items="${service}">

					<input type="radio" name="service"
						value="${listValue.serviceProviderName}" />${listValue.serviceProviderName} 				
											<br>
				</c:forEach> <!--                                     <input type="radio" class="radiobutton" name="my-radiobutton-group-1" id="service"> -->
				<!--                                     <span class="custom-radiobutton"></span> -->
				<!--                                     India Post --> <!--                                 </label> -->
				<!--                                 <label class="label"> --> <!--                                     <input type="radio" class="radiobutton" name="my-radiobutton-group-1" id="service" > -->
				<!--                                     <span class="custom-radiobutton"></span> -->
				<!--                                     Blue Dart -->
			</label>
		</div>
	...
	<script>
		...
		$(function() {
			...
			var start = [ "Start 1", "Start 2", "Start 3", "Start 4" ];
			var end = [ "End 1", "End 2", "End 3", "End 4" ];
